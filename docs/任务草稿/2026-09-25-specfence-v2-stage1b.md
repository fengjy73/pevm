...
4. **已完成** — `docs/specfence-v2-stage1.md` 已写 Stage 1b。最终二进制上 `sf_matches_onchain_focus_blocks`（3.89s）、`sf_seq_par_repeat`（1.17s）和 `sload_static_gas_matches_chain_header`（0.66s）通过。随后提交并开 PR。
