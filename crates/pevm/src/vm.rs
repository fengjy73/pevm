...
impl<'a, S: Storage> VmDb<'a, S> {
    ...
    fn pcc_serial_lane(
        ...
        // Ready/Aborting: one Spec canary + ProducerStage/edge so reincarnation
        // is refused. Parking Ready hangs (v6). Not prefer_admit-without-progress:
        // w is reserved and admitted.
        self.occ_unfenced()
    }
