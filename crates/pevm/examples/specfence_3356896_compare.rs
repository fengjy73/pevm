    ...
    match result {
        Ok(_) => {
            ...
            if mode_name == "specfence" {
                ...
                println!(
                    "  spine {mode_name}[{i}] access={} yield_ok={} yield_deadlock={} raw={} waw={} war={} armed={} pins={} revoked={} radar={} est_block={} soft={} occ_picks={}",
                    spine.access_events,
