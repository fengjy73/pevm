...
稳定主名单（绝对墙 + 倍数并集；13217637 仅 OCC reuse 轻度漂移、SF 墙稳定，仍入选）：`14396881, 15274915, 13217637, 19807137, 17666333, 15538827, 14334629, 15199017`。
