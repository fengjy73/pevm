...
- Mid-band coverable spines still probe Win_2; unproven probe stays Win_2.
- 19469101 leftover-slide hang class: mid-band leftover does not T3-slide; skip_useless_cover_probe is large-only.
